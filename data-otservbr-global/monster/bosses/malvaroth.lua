...
monster.attacks = {
	-- Melee físico forte
	{ name = "melee", interval = 2000, chance = 100, minDamage = -10000, maxDamage = -15000 },
	...
	{ name = "combat", interval = 6000, chance = 25, type = COMBAT_ENERGYDAMAGE, length = 8, spread = 4, effect = CONST_ME_ENERGYHIT, minDamage = -20000, maxDamage = -25000 },
