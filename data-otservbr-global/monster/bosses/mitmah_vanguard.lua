...
monster.attacks = {
	{ name = "melee", interval = 1700, chance = 100, minDamage = -2400, maxDamage = -5856 },
	{ name = "melee", interval = 2500, chance = 100, minDamage = -2500, maxDamage = -5256 },
	...
	{ name = "combat", interval = 2500, chance = 33, type = COMBAT_ENERGYDAMAGE, minDamage = -2500, maxDamage = -3500, length = 8, spread = 0, effect = CONST_ME_PURPLEENERGY, target = false },
	{ name = "combat", interval = 2000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -2600, maxDamage = -3000, length = 8, spread = 2, effect = CONST_ME_HITBYFIRE, target = false },
	{ name = "combat", interval = 1000, chance = 30, type = COMBAT_ENERGYDAMAGE, minDamage = -2400, maxDamage = -3600, range = 7, radius = 2, shootEffect = CONST_ANI_BOLT, effect = CONST_ME_ENERGYHIT, target = true },
}
