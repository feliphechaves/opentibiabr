...
monster.attacks = {
    ...
    { name = "reta", interval = 2000, chance = 30, type = COMBAT_HOLYDAMAGE, minDamage = -200000, maxDamage = -200000, length = 8, spread = 0, shootEffect = CONST_ANI_HOLY, effect = CONST_ME_HOLYDAMAGE, target = false },
}
