...
monster.health = 18200
monster.maxHealth = 18200
monster.race = "fire"
monster.corpse = 5995
monster.speed = 128
monster.manaCost = 0
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -1050, maxDamage = -1500, range = 7, radius = 7, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "firefield", interval = 2000, chance = 10, range = 7, radius = 1, shootEffect = CONST_ANI_FIRE, target = true },
