local mType = Game.createMonsterType("Goshnars Megalomania")
local monster = {}

monster.description = "Goshnars Megalomania"
...
monster.attacks = {
	...
	{name ="singlecloudchain", interval = 6000, chance = 40, minDamage = -1300, maxDamage = -6500, range = 6, effect = CONST_ME_ENERGYHIT, target = true},
