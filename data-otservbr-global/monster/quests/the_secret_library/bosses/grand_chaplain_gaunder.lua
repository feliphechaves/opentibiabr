...
monster.loot = {
	...
	{ name = "falcon battleaxe", chance = 5 }, --200
	{ name = "falcon longsword", chance = 5 }, --200
	{ name = "falcon mace", chance = 5 }, --210
	{ name = "falcon plate", chance = 2 }, --100
	{ name = "falcon shield", chance = 2 }, --100
}
