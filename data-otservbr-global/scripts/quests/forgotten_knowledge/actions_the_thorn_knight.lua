local config = {
	...
	playerPositions = {
		...
		{ pos = Position(32657, 32878, 14), teleport = Position(32624, 32886, 14) },
		{ pos = Position(32657, 32879, 14), teleport = Position(32624, 32886, 14) },
		{ pos = Position(32657, 32880, 14), teleport = Position(32624, 32886, 14) },
		{ pos = Position(32657, 32881, 14), teleport = Position(32624, 32886, 14) },
	},
	monsters = {
