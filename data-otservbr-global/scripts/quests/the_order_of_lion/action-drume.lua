local config = {
	...
	usurperPosition = {
		...
		Position(32450, 32521, 7),
		Position(32450, 32522, 7),
		Position(32450, 32523, 7),
		Position(32450, 32524, 7),
		Position(32444, 32516, 7),
		Position(32444, 32517, 7),
		Position(32444, 32518, 7),
		Position(32444, 32519, 7),
		Position(32444, 32520, 7),
		Position(32448, 32512, 7),
		Position(32448, 32513, 7),
		Position(32448, 32514, 7),
		Position(32448, 32515, 7),
		Position(32448, 32516, 7),
	},
