	...
	},
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 49605,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, distance fighting +3, magic level +2, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
				home = true,
	...
	},
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 49602,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, distance fighting +2, magic level +1, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
				home = true,
