		...
		offers = {
			{
				...
				itemtype = 65015,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, distance fighting +3, magic level +4, protection fire +13%, ice +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
			{
				...
				itemtype = 65016,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, distance fighting +3, magic level +4, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
			{
				...
				itemtype = 65017,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, distance fighting +3, magic level +4, protection holy +13%, death +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
		...
		offers = {
			{
				...
				itemtype = 65012,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, distance fighting +2, magic level +3, protection fire +13%, ice +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
			{
				...
				itemtype = 65013,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, distance fighting +2, magic level +3, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
			{
				...
				itemtype = 65014,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, distance fighting +2, magic level +3, protection holy +13%, death +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				movable = true,
			},
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			--60k
			{
				...
				itemtype = 35280,
				charges = 60000,
				description = "<i>Use it to train your axe fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your axe fighting skill\n{info} usable 60000 times a piece",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
