...
HomeBanners = {
	images = { "home/banner_aiolosot.png", "home/banner_addondoll.png", "home/banner_relics.png" },
	delay = 10,
}
...
GameStore.Categories = {
		...
		offers = {
			{
				...
				name = string.format("5 Days of %s", premiumOfferName),
				price = 5,
				id = 3005,
				validUntil = 5,
	...
	},
	{
		...
		offers = {
			{
				icons = { "Earth_Protector.png" },
				name = "Earth Protector",
				price = 10,
				itemtype = 65005,
				charges = 1,
				description = "Equippable in the torch slot \nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection earth +12% \n 1 slot imbuement",
			...
			},
			{
				...
				itemtype = 65006,
				charges = 1,
				description = "Equippable in the torch slot \nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection holy +12% \n 1 slot imbuement",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65007,
				charges = 1,
				description = "Equippable in the torch slot \nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection ice +12% \n 1 slot imbuement",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65008,
				charges = 1,
				description = "Equippable in the torch slot\nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection death +12% \n 1 slot imbuement",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65009,
				charges = 1,
				description = "Equippable in the torch slot\nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection fire +12% \n 1 slot imbuement",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65010,
				charges = 1,
				description = "Equippable in the torch slot\nclub fighting +3, sword fighting +3, axe fighting +3, fist fighting +3, distance fighting +3, magic level +3, protection energy +12% \n 1 slot imbuement",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
		},
		...
		offers = {
			{
				...
				itemtype = 65015,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, fist fighting + 4, distance fighting +3, magic level +4, protection fire +13%, ice +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65016,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, fist fighting + 4, distance fighting +3, magic level +4, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65017,
				charges = 1,
				description = "Arm:4, club fighting +5, sword fighting +5, axe fighting +5, fist fighting + 4, distance fighting +3, magic level +4, protection holy +13%, death +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
		...
		offers = {
			{
				...
				itemtype = 65012,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, fist fighting + 3, distance fighting +2, magic level +3, protection fire +13%, ice +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65013,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, fist fighting + 3, distance fighting +2, magic level +3, protection earth +13%, energy +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 65014,
				charges = 1,
				description = "Arm:3, club fighting +4, sword fighting +4, axe fighting +4, fist fighting + 3, distance fighting +2, magic level +3, protection holy +13%, death +13%",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
		...
		offers = {
			{
				...
				itemtype = 37749,
				charges = 1,
				description = "Um artefato lendario que canaliza o poder das almas flamejantes. \nAo ser ativado, concede +15 na sua habilidade de combate principal (Melee, Distance ou Magic Level) e +5% de chance de acerto critico por 1 hora. \nA reliquia entra em chamas quando usada. \nCusta 50kk de gold por ativacao e possui tempo de recarga de 1 hora. \nNao consumida ao usar. \nIdeal para eventos e bosses poderosos.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
			{
				icons = { "soulfrost_relic.png" },
				name = "Soulfrost Relic",
				price = 25,
				itemtype = 22889,
				charges = 1,
				description = "Uma reliquia ancestral que invoca o escudo das forcas elementais. \nAo ser ativada, concede +15 em Shielding, +10% de resistencia fisica e +10% de resistencia a todos os tipos de dano (fisico, fogo, gelo, energia, terra, holy e death) por 1 hora. \nCusta 50kk de gold por ativacao e possui tempo de recarga de 1 hora. \nNao consumida ao usar. \nPerfeita para suportar ataques pesados em batalhas intensas.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				state = GameStore.States.STATE_NEW,
				home = true,
			},
	...
	-- Consumables
	{
		...
		name = "Consumables",
		rookgaard = true,
		subclasses = { "Blessings", "Casks", "Exercise Weapons", "Kegs" },
	},
		...
		offers = {
			{
				...
				itemtype = 2851,
				count = 1,
				description = "Garante protecao 100% contra toda perda de experiencia na morte (apenas experiencia). \nUso unico! Esse item nao eh infinito. \nAPENAS PLAYERS VIPS PODEM USAR ISSO. ",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
	...
	-- Consumables ~ Exercise Weapons
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 65024,
				charges = 65000,
				description = "<i>Use it to train your axe skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} usable 65000 times a piece \n{info} double atack speed boost",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = {},
				name = "Boosted Exercise Bow",
				price = 3,
				itemtype = 65025,
				charges = 65000,
				description = "<i>Use it to train your distance skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} usable 65000 times a piece \n{info} double atack speed boost",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = {},
				...
				itemtype = 65026,
				charges = 65000,
				description = "<i>Use it to train your club skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} usable 65000 times a piece \n{info} double atack speed boost",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = {},
			...
			{
				icons = {},
				name = "Boosted Exercise Rod",
				price = 3,
				itemtype = 65028,
				charges = 65000,
				description = "<i>Use it to train your magic skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} usable 65000 times a piece \n{info} double atack speed boost",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
			},
			{
				icons = {},
		...
		offers = {
			{
				...
				price = 4,
				id = 232,
				description = "Primal Demonosaur",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				home = true,
				offerstate = GameStore.States.STATE_NEW,
			},
			{
				icons = {},
				name = "Red Demonosaur",
			...
			{
				icons = {},
				name = "Rock Demonosaur",
				price = 4,
				id = 234,
				description = "Rock Demonosaur",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				home = true,
				offerstate = GameStore.States.STATE_NEW,
			},
			...
			},
			{
				...
				price = 3,
				id = 126,
				description = "Fleeting Knowledge",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
			...
			},
			{
				...
				price = 3,
				id = 132,
				description = "Cold Percht Sleigh",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 133,
				description = "Bright Percht Sleigh",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 134,
				description = "Dark Percht Sleigh",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Gryphon.png" },
			...
			},
			{
				...
				price = 3,
				id = 147,
				description = "Cold Percht Sleigh Variant",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 148,
				description = "Bright Percht Sleigh Variant",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 149,
				description = "Dark Percht Sleigh Variant",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 150,
				description = "Cold Percht Sleigh Final",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 151,
				description = "Bright Percht Sleigh Final",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 152,
				description = "Dark Percht Sleigh Final",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 156,
				description = "Blue Rolling Barrel",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 157,
				description = "Red Rolling Barrel",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 158,
				description = "Green Rolling Barrel",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Haze.png" },
			...
			},
			{
				...
				price = 3,
				id = 224,
				description = "Dawnbringer Pegasus",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Wrathfire Pegasus.png" },
				name = "Wrathfire Pegasus",
				price = 3,
				id = 225,
				description = "Wrathfire Pegasus",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				...
				price = 3,
				id = 226,
				description = "Skybreaker Pegasus",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
				icons = { "Pegasus.png" },
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
			{
				icons = {},
				name = "Full Necromancer",
				price = 10,
				sexId = { female = 1846, male = 1845 },
				addon = 3,
				description = "Full Necromancer",
			...
			{
				icons = {},
				name = "Full Fiend Slayer",
				price = 10,
				sexId = { female = 1808, male = 1809 },
				addon = 3,
				description = "Full Fiend Slayer",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
				home = true,
				state = GameStore.States.STATE_NEW,
			},
			{
				icons = {},
				name = "Full Martial Artist",
				price = 10,
				sexId = { female = 1838, male = 1837 },
				addon = 3,
				description = "Full Martial Artist",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
				home = true,
				state = GameStore.States.STATE_NEW,
			},
			{
				icons = {},
				name = "Full Field Surgeon",
				price = 10,
				sexId = { female = 1815, male = 1814 },
				addon = 3,
				description = "Full Field Surgeon",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
				home = true,
				state = GameStore.States.STATE_NEW,
			},
			...
			{
				icons = { "Outfit_Mage_Male.png", "Outfit_Mage_Female.png" },
			...
			{
				icons = { "Outfit_Barbarian_Male.png", "Outfit_Barbarian_Female.png" },
	...
	-- House ~ Upgrades
	{
		...
		offers = {
			...
			{
				icons = { "Aiolos_Exercise_Dummy.png" },
				name = "Aiolos Exercise Dummy",
				price = 30,
				itemtype = 65002,
				count = 1,
	...
	-- Extras
	{
		...
		name = "Extras",
		rookgaard = true,
		subclasses = { "Extra Services", "Useful Things", "Tibia Coin to Item" },
	},
	...
	-- Extras ~ Usefull Things
	{
		...
		offers = {
			...
			},
			{
				...
				itemtype = 65011,
				count = 1,
				description = "Food infinita. Item infinito.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM_UNIQUE,
				movable = true,
			},
			{
				icons = {},
				name = "Seed of the Gods",
				price = 2,
				itemtype = 11685,
				count = 1,
				description = "Ao ser usada, essa semente enche toda sua stamina! \nUso unico. Esse item nao eh infinito.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
				...
				itemtype = 12210,
				count = 1,
				description = "Quando usado voce recebera 500 major charm points.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
				movable = true,
			},
			{
			...
			},
			{
				...
				count = 1,
				itemtype = 39036,
				description = "Ficha para usar a Premium Roulette.",
			...
			-- 	price = 10,
			-- 	itemtype = 12540,
			-- 	description = "Use esse scroll magico para mudar para uma nova classe. \nAs skills serao adaptadas para a nova classe escolhida, apenas o skill primario mais alto sera mantido, os outros serao balanceados para um nivel mais basico. \nDesequipe todos os seus itens antes de usar!",
			-- 	type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			-- 	movable = true,
			-- },
		},
		...
		offers = {
			{
				...
				movable = true,
				count = 1,
				description = "Reduces the cooldown time of all spells to zero, once.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Increases the chance of dealing critical damage by 5% for one hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Fills one hour of stamina, but does not exceed the maximum limit.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Increases the chances of triggering an offensive charm by 5% (except Cripple) for one hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Doubles the loot from all normal monsters killed for one hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Makes kills for the Bestiary count twice for one hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
				...
				movable = true,
				count = 1,
				description = "Increases protection by 8% for one hour.",
				type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
			},
			{
...

	{
		...
		offers = {
			...
			},
			{
				...
				price = 500,
				id = 26,
				description = "Rented Horse (Brown)",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
				coinType = GameStore.CoinType.Coin,
			},
			{
...

	{
		...
		offers = {
			...
			},
			{
				...
				count = 1,
				itemtype = 22722,
				description = "Coin to use in roulette",
				type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
				coinType = GameStore.CoinType.Coin,
				movable = true,
			},
