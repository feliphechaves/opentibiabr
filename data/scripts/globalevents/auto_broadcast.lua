...
function AutoBroadCast.onThink(interval, lastExecution)
    ...
    "[Gold Tokens]: Upgrade your gear! Exchange your Gold Tokens for Tier 4 items with Goldoken. Don't miss the opportunity to get stronger!",
    ...
    "[Daily Boss]: Ready for epic rewards? The Daily Boss spawns every day at 21:00! Find the teleport in the center of Thais temple and claim amazing loot. Don’t miss it!",
