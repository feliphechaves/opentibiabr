    ...
    if resultId then
        repeat
            ...
            if expYesterday == 0 then
                ...
                db.asyncQuery("INSERT INTO aiolos_highexpday (player_id, exp_yesterday, exp_today) VALUES (" 
                    .. playerId .. ", " .. currentExp .. ", 0)")
            else
                -- Atualizar registro existente
                db.asyncQuery("UPDATE aiolos_highexpday SET exp_yesterday = " .. currentExp .. ", exp_today = " 
                    .. expToday .. " WHERE player_id = " .. playerId)
            end
        until not Result.next(resultId)
